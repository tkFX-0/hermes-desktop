...
export function PixelRoomFloor(): React.JSX.Element {
  return (
    <>
      {/* Main floor — dark tile base with stronger grid */}
      <div
        aria-hidden
        style={{
          position: "absolute",
          ...
          background: "#050c18",
          backgroundImage:
            "linear-gradient(rgba(45,70,160,0.38) 1px, transparent 1px)," +
            "linear-gradient(90deg, rgba(45,70,160,0.38) 1px, transparent 1px)",
      ...
      <div
        ...
        style={{
          ...
          zIndex: 1,
          backgroundImage:
            "repeating-conic-gradient(rgba(28,48,110,0.20) 0% 25%, transparent 0% 50%)",
          backgroundSize: "44px 30px",
          pointerEvents: "none",
        }}
      />

      {/* Center floor warmth — reflects ceiling light pool */}
      <div
        aria-hidden
        style={{
          position: "absolute",
          ...
          zIndex: 2,
          background:
            "radial-gradient(ellipse, rgba(88,130,255,0.07) 0%, transparent 70%)",
          pointerEvents: "none",
        }}
      />
      ...
      <div
        ...
        style={{
          ...
          zIndex: 3,
          background:
            "radial-gradient(ellipse, rgba(88,130,255,0.05) 0%, transparent 70%)",
          pointerEvents: "none",
        }}
      />
    </>
