...
import { buildMobileSnapshot } from "../../../../shared/mobile-console";
...
// Phase 2A: redacted snapshot built from safe defaults.
// Phase 2B will replace this with a live IPC call.
const SNAPSHOT = buildMobileSnapshot(undefined, "redacted_snapshot_phase2a");
...
/** iPhone Private Console — Phase 2A: typed redacted snapshot / 実行なし / APIなし */
  ...
  return (
    <div style={{ flex: 1, display: "flex", flexDirection: "column", height: "100%", background: "#0d1117", color: "#c9d1d9", overflow: "auto", padding: 16, maxWidth: 430, margin: "0 auto", width: "100%" }}>
      <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 12 }}>
        ...
        <span style={{ marginLeft: "auto", fontSize: 10, color: "#8b949e", background: "#21262d", border: "1px solid #30363d", borderRadius: 3, padding: "2px 6px" }}>Phase 2A</span>
      </div>
      ...
      <div style={{ background: "rgba(88,166,255,0.07)", border: "1px solid rgba(88,166,255,0.3)", borderRadius: 6, padding: "7px 12px", marginBottom: 12, fontSize: 11, color: "#58a6ff", lineHeight: 1.5 }}>
        このiPhone Private Console Phase 2Aは静的/read-onlyです。<br />
