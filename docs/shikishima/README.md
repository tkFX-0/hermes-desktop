...
- `LOCAL_MVP_OPERATION_EVIDENCE_2026-05-16-009.md` - v3.21.0 Session-009 iPhone same-LAN evidence; CLEAN_B3_PASS_CANDIDATE; B3 5/5 candidate pending human acceptance; no Level 3, productionReady, execution, or runtime branch push approval.
